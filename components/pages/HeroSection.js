...
const HERO_TAGLINE = "Innovative Digital Solutions";
const HERO_TITLE = "Transforming Ideas into Stunning Web Experiences";
...
// const HEADING = {
//   HEADING_PRIMARY: "WE PROVIDE ADVANCED",
//   HEADING_SECONDARY: "WEB DESIGN SERVICE IN RANCHI",
//   SUBTEXT: "We are Freelancers",
// };

// const GUARANTEE = {
//   GUARANTEE_HEADING: "Money\nBack\nGuaranty",
//   GUARANTEE_PERCENTAGE: "100%",
//   GUARANTEE_TEXT:
...
const HEADING = {
  HEADING_PRIMARY: "ELEVATE YOUR ONLINE PRESENCE",
  HEADING_SECONDARY: "PREMIUM WEB DESIGN SERVICES IN RANCHI",
  SUBTEXT: "Crafting Stunning & High-Performance Websites",
};
...
const GUARANTEE = {
  ...
  GUARANTEE_PERCENTAGE: "100%",
  GUARANTEE_TEXT:
    "We are committed to delivering top-notch web solutions. If you're not satisfied, we offer a full refund—no questions asked. Your satisfaction is our priority!",
};
  ...
  return (
    <>
      ...
      <div className="container relative z-10 max-w-6xl mx-auto px-4 pt-12 text-center">
        ...
        <p className="text-xl font-era text-gray-600 mb-8">{HEADING.SUBTEXT}</p>
        <div
          ref={containerRef}
        ...
        <div className="max-w-6xl mx-auto  text-left">
          <div className="mb-4 relative overlapText">
            <h3 className="text-2xl  font-eraBold mb-2">{GUARANTEE.GUARANTEE_HEADING}</h3>
            <span className="fadedText top-20 absolute text-8xl font-bold font-eraBold text-gray-900">
              {GUARANTEE.GUARANTEE_PERCENTAGE}
            </span>
          </div>
          <p className="text-gray-600  mb-4">{GUARANTEE.GUARANTEE_TEXT}</p>
