      ...
      <div className="relative aspect-[4/2] md:aspect-[3.1] rounded-2xl overflow-hidden mb-4 bg-black">
        ...
        <div className="absolute inset-0 flex items-center p-8 ">
          <div className="text-white text-left max-w-md tracking-widest">
            <p style={{textShadow:'0 0 12px #111'}} className="text-sm mb-4">Landmark Analytics</p>
            <h4 style={{textShadow:'1px 1px 1px #111'}} className="text-lg md:text-3xl font-era font-bold mb-6">
...
function Feature({ icon, text }) {
  return (
    <div
      ...
      className="flex hover:bg-black hover:text-white cursor-pointer bg-white rounded-full items-center gap-2 text-black px-1 sm:px-5 py-1"
    >
      {icon}
