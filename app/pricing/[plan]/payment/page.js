...
import {
  PricingProvider,
  usePricing,
} from "@/components/pages/pricing/pricingContext";
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      ...
      <div className="mt-4 w-full max-w-md text-sm text-gray-600">
        <div className="flex justify-center">
          ...
          <label htmlFor="agree">
            I agree to the 
            <a href="/policies/terms-conditions" className="text-blue-600 underline mr-2" target="_blank"> Terms & Conditions</a>and 
          </label>
